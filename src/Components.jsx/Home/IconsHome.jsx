...
export const IconsHome = () => {
  const footerLinks = [
    {
      ...
      icon: <ImLinkedin className="dark:text-teal-500 text-teal-800 text-xl" />,
    },
    {
      href: "https://x.com/omoweadebayo",
      icon: <FaSquareXTwitter className="dark:text-teal-500 text-teal-800 text-xl" />,
    },
    {
      href: "https://github.com/HARDARB",
      icon: <FaGithubSquare className="dark:text-teal-500 text-teal-800 text-xl" />,
    },
    {
      href: "https://t.me/HARDARB",
      icon: <FaTelegram className="dark:text-teal-500 text-teal-800 text-xl" />,
    },
   {
  ...
  return (
    <motion.div className="text-white font-poppins max-w-5xl mx-auto relative">
      <footer className="pt-10 pb-2 text-sm dark:text-gray-300 text-black  ">
